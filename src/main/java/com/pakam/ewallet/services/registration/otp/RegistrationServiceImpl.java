...
public class RegistrationServiceImpl implements RegistrationService{
    ...
    public String register(RegistrationRequest registrationRequest) throws MessagingException {
        ...
        VerifyOTPRequest otpVerificationRequest = new VerifyOTPRequest();
        otpVerificationRequest.setEmailAddress(registrationRequest.getEmailAddress());
        otpVerificationRequest.setOneTimePassword(oTP);
        emailSender.send(otpVerificationRequest);
        return oTP;
    }
    ...
    public String verifyOTP(VerifyOTPRequest verifyOTPRequest) {
        ...
        Long userId = userRepo.findUserByEmailAddressIgnoreCase(verifyOTPRequest.getEmailAddress()).get().getId();
        return "verified with user ID : " + userId ;
    }
    ...
    public String resendVerificationOTP(SendOTPRequest sendOTPRequest) throws MessagingException {
        ...
        VerifyOTPRequest otpVerificationRequest = new VerifyOTPRequest();
        otpVerificationRequest.setEmailAddress(sendOTPRequest.getEmailAddress());
        emailSender.send(otpVerificationRequest);
