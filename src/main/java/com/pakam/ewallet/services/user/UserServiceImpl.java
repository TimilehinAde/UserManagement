...
import com.pakam.ewallet.data.models.*;
import com.pakam.ewallet.data.repositories.UserRepo;
...
import com.pakam.ewallet.dtos.response.bankcoderesponse.Bank;
import com.pakam.ewallet.dtos.response.bankcoderesponse.BankCodePaystackResponse;
import com.pakam.ewallet.dtos.response.bvnvalidationpaystackresponse.BVNValidationPaystackResponse;
import com.pakam.ewallet.dtos.response.createtransferrecipientpaystackresponse.CreateTransferRecipientPaystackResponse;
import com.pakam.ewallet.dtos.response.getbankspaystackresponse.BankName;
import com.pakam.ewallet.dtos.response.getbankspaystackresponse.GetBanksPaystackResponse;
import com.pakam.ewallet.exceptions.GenericHandlerException;


import com.pakam.ewallet.services.cardservices.CardService;
import com.pakam.ewallet.services.email.EmailSender;
import com.pakam.ewallet.services.email.EmailSenderImpl;
import com.pakam.ewallet.services.registration.otp.VerificationOTPService;
import com.pakam.ewallet.utils.OTPGenerator;
...
public class UserServiceImpl implements UserService {
    ...
    public String createTransferRecipient(CreateTransferRecipientRequest createTransferRecipientRequest) throws IOException {
        ...
        try {
            ...
            emailSender.sendFailedTransactionMessage(
                    userRepo.findById(createTransferRecipientRequest
                            .getUserId()).get().getEmailAddress()
            );
    ...
    public String login(LoginRequest loginRequest) {
        ...
        if (!passwordEncoder.matches(loginRequest.getPassword(), foundUser.getPassword()))
            throw new GenericHandlerException("Incorrect Password");
    ...
    public String changePassword(ChangePasswordRequest changePasswordRequest) {
        ...
        if (!passwordEncoder.matches(changePasswordRequest.getCurrentPassword(), findUser.getPassword()))
            throw new GenericHandlerException("Incorrect Password!");
        if (!Objects.equals(changePasswordRequest.getNewPassword(), changePasswordRequest.getConfirmNewPassword()))
            throw new GenericHandlerException("Password Not Match!");
